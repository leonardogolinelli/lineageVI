...
SAVE_FREQ="25"
DT="" # default is 0.1
LAMBDA_PROGRESS="10000.0" # default is 1.0
LAMBDA_ACT="1" # default is 0.02
LAMBDA_MAG="1" # default is 0.15
R_SUCC="1000" # default is 20.0
ALPHA_STAY="1.0" # default is 0.0 (state cost for staying near goal)
