...
extensions = [
    ...
    'jupyter_sphinx',  # Support for Jupyter notebooks without pandoc dependency
]
...
latex_documents = [
    ('index', 'LineageVI.tex', 'LineageVI Documentation',
     'LineageVI Team', 'manual'),
]
...
man_pages = [
    ('index', 'lineagevi', 'LineageVI Documentation',
     [author], 1)
]
